 ...
 */
public class redacdr extends FragmentActivity {

    static final int NUM_ITEMS = 8;
    ImageFragmentPagerAdapter imageFragmentPagerAdapter;
    icw.slaf.slafdresscode.ViewPagerFixed viewPager;
    public static final String[] IMAGE_NAME = {"redacdr1", "redacdr2", "redacdr3", "redacdr4", "redacdr5", "redacdr6","redacdr7","redacdr8",};
