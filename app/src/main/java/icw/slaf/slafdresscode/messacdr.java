 ...
 */
public class messacdr extends FragmentActivity {

    static final int NUM_ITEMS = 8;
    ImageFragmentPagerAdapter imageFragmentPagerAdapter;
    ViewPagerFixed viewPager;
    public static final String[] IMAGE_NAME = {"messacdr1", "messacdr2","messacdr3","messacdr4", "messacdr5", "messacdr6","messacdr7","messacdr8", };
