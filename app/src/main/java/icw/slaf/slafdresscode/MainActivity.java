...
public class MainActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSamples = new Sample[]{
                new Sample(R.string.title_Officers, icw.slaf.slafdresscode.Officers.class),
                new Sample(R.string.title_airmen, Airmen.class),
                new Sample(R.string.title_civil, Civil.class),
