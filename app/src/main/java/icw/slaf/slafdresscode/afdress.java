 ...
 */
public class afdress extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSamples = new Sample[]{
                new Sample(R.string.title_fgtb, fdfgt.class),
                new Sample(R.string.title_mwo, fdmwo.class),
    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        startActivity(new Intent(afdress.this, mSamples[position].activityClass));
    }
}
