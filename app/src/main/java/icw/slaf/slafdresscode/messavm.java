 ...
 */
public class messavm extends FragmentActivity {

    static final int NUM_ITEMS = 8;
    ImageFragmentPagerAdapter imageFragmentPagerAdapter;
    ViewPagerFixed viewPager;
    public static final String[] IMAGE_NAME = {"messavm1", "messavm2","messavm3","messavm4","messavm5","messavm6","messavm7","messavm8",  };
